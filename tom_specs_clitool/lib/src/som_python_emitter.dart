...
class SomPythonEmitter {
  ...
  String generateLibrary() {
    ...
    final buffer = StringBuffer()
      ..writeln(
        '# GENERATED by tom_specs_clitool SomPythonEmitter '
    ...
    buffer
      ...
      ..writeln(
        'from tom_som_python_${versionLabel}_meta import *  '
        '# noqa: F401,F403',
      )
      ..writeln();
  ...
  String _emitClass(
    ...
    if (isRoot) {
      ...
      b
        ...
        ..writeln(
          "        \"\"\"This object model's own model version "
        ...
        ..writeln(
          '        editable by this object model, **without raising** '
          '(SOM §21) — the',
        )
        ..writeln(
      ...
      case SpecFieldKind.enumValue:
        if (f.enumType == null) {
          ...
          b
            ...
            ..writeln(
              '        self.doc.set_content($childPath, '
      ...
      case SpecFieldKind.list:
        ...
        if (f.elementIsComplex && f.elementType != null) {
          ...
          b
            ...
            ..writeln('    def $acc(self):')
            ..writeln(
              '        return SomList(self.doc, $childPath, '
    ...
    switch (_scalarType(ff.type)) {
      ...
      default:
        b
          ...
          ..writeln(
            '        return self.doc.form_field(self.path, $field) or ""',
          )
          ..writeln()
          ..writeln('    @$acc.setter')
          ..writeln('    def $acc(self, value):')
          ..writeln(
            '        self.doc.set_form_field(self.path, $field, value)',
          );
    }
  }
  ...
  String _fstr(String s) =>
      _pystr(s).replaceAll('{', '{{').replaceAll('}', '}}');
