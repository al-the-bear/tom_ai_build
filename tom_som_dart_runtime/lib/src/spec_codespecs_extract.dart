...
class CodeSpecsExtract {
  ...
  String toYaml() {
    ...
    b.writeln(
      '# ${area.code}.extract.yaml — generated by '
  ...
  String toMarkdown() {
    ...
    b.writeln(
      '`${area.code}.extract.yaml` beside this file is the artifact of '
...
String _mdIntList(List<int> values) => values.isEmpty ? '—' : values.join(', ');
