...
SomPythonGenerationResult writeSomPythonProject({
  ...
  File(p.join(outputRoot, 'meta', '__init__.py')).writeAsStringSync(
    _dataPackageInit(
      packageName,
      folder: 'meta',
  ...
  File(p.join(outputRoot, 'schemas', '__init__.py')).writeAsStringSync(
    _dataPackageInit(
      packageName,
      folder: 'schemas',
