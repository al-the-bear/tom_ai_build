...
class SomJavaScriptMetaEmitter {
  ...
  String generateLibrary() {
    final b = StringBuffer()
      ..writeln('// GENERATED by tom_specs_clitool SomJavaScriptMetaEmitter '
      ...
      ..writeln('// The generic runtime is located at load time through the '
          '`tomSom.runtimePath`')
      ..writeln('// recorded in this package\'s `package.json` (written by '
          'the generator), so')
  ...
  List<String> _emitRoot(StringBuffer b, SpecRoot root) {
    ...
    b
      ...
      ..writeln('const $camel = new ${root.type}\$Nav(${camel}MetaTree, '
          '${_str(seg)});')
      ..writeln()
      ..writeln('// ID-tree access root of `${root.type}` (SOM §8):')
      ..writeln('// `$idSymbol.<SECTION-ID>….path` / `.meta`.')
      ..writeln('const $idSymbol = new ${root.type}\$Id(${camel}MetaTree, '
          '${_str(seg)});')
      ..writeln();
