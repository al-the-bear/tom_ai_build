...
const SPEC_PATH_SEPARATOR = '/';

/** Joins `parent` with a child `segment` using the path separator. */
function specPathJoin(parent, segment) {
 ...
 */
function specPathSegments(path) {
 ...
 */
function splitListItemSegment(segment) {
