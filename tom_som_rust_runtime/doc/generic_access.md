# Generic access — `tom_som_rust_runtime`

The reflective, untyped half of the Rust SOM plane: the document as a
...
[`tom_som_rust_v0/doc/tutorial.md`](../../tom_som_rust_v0/doc/tutorial.md).
...
classes**. Those belong to `tom_som_rust_v0`, which is a view over exactly the
...
```bash
cargo add tom_som_rust_runtime
```
...
| the editing-facade bases | What the generated `tom_som_rust_v0` types extend |
...
./tool/regenerate_api_references.sh rust_runtime
```
