...
/// committed artefact tree (SOM §4.3): the `tom_som_cpp_<label>` project (a
...
class SomCppGenerationResult {
  ...
  /// The created `tom_som_cpp_<label>` project directory, as the resolved
  ...
  /// generated source — is what wires `RUNTIME_DIR` to the
  /// `tom_som_cpp_runtime` checkout; a consumer that builds without it will
  /// fail to find the runtime header.
  final String makefilePath;

  /// The generated typed facade header (`include/tom_som_cpp_v0.hpp`): the
  /// declarations a consumer includes.
  final String headerPath;

  /// The generated typed facade translation unit (`src/tom_som_cpp_v0.cpp`),
