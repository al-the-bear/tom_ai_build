...
Generated typed TomSpecs object model (v1.1.0) for Python. An editing facade over the generic `tom_som_python_runtime`; regenerate with `tom_specs_clitool/bin/generate_som.dart`.
