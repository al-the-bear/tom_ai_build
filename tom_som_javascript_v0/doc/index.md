# tom_som_javascript_v0 — documentation

The package documentation for `tom_som_javascript_v0`: how to use this package's code. It is
...
| Document | Covers |
|----------|--------|
| [tutorial.md](tutorial.md) | Using the SOM from JavaScript end to end: install, open a document, read a section, edit it, validate it and serialize it — one verified program, with its real output |

## API reference

`doc/api/reference/` holds the generated reference, rendered with `typedoc`.
...
[`tom_som_javascript_runtime`](../../tom_som_javascript_runtime), documented in
[`tom_som_javascript_runtime/doc/generic_access.md`](../../tom_som_javascript_runtime/doc/generic_access.md). A consumer
