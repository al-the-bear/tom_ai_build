...
Generated typed TomSpecs object model (v1.0.0) for TypeScript. An editing facade over the generic `tom_som_typescript_runtime`; regenerate with `tom_specs_clitool/bin/generate_som.dart`.
