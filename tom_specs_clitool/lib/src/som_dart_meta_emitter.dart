/// Emits the generated **metadata library** of the Dart `v0` facade (DR8):
...
/// ids, §4.2). This library replaces the retired flat path-constant holders
...
///
/// Surface shapes (Dart reference implementation, DR1 §4.3):
///
...
///
/// Naming divergence from the DR1 §4.1 illustration: Dart forbids a static
