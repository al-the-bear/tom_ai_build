# Tom Spec Engine - Copilot Guidelines

**Project:** `tom_spec_engine`
...
| Document | Purpose |
|----------|---------|
| [Bridge Regeneration](bridge_regeneration.md) | When and how to regenerate the SOM D4rt `*.b.dart` bridges |

## Quick Reference

See project README and `../../tom_specs_model/doc/llm_and_d4rt_tools.md` for the
