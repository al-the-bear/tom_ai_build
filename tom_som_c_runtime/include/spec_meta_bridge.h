 ...
 * canonical metadata tree (SomMetaTree, SOM §7.1), a faithful port of the Go
 ...
 * by. (SOM §12.2's "field id, else target-class id" resolution is applied at
 * *export* time by the model exporter / SOM generator, not re-derived here.)
 *
