...
void main() {
  ...
  group('SomJavaEmitter', () {
    test(
      'emitted output matches the committed golden files (facade + meta)',
      () {
    ...
    test('the generated source compiles against the runtime (javac)', () {
      ...
      final metaSource = SomJavaMetaEmitter(_fixtureModel()).generateLibrary();
    ...
    test(
      ...
      () {
        ...
        expect(
          SomJavaEmitter(stamped, versionLabel: 'v0').modelVersionString,
          '1.3',
        );
        expect(
          SomJavaEmitter(stamped, versionLabel: 'v9').modelVersionString,
          '1.3',
        );
      },
    );
    ...
    test('no flat path-constant holder is emitted; the loaders thread the '
