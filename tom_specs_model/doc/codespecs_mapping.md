...
**Two verification blockers stand besides, both of mode V.** Each is a cross-part
...
resolves: `TomJobDeclaration.targetRefs` at slice 7 (`csrc1`) and CE-RP's four
targets at slices 2 and 3 (`csrc3`). Neither blocks emission; each removes a
guarantee the slice order otherwise gives for free.
