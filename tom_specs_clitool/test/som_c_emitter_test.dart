...
void _expectCBuilds(
  ...
  try {
    ...
    File(
      p.join(dir.path, 'tom_som_c_v0_meta.h'),
  ...
  group('SomCEmitter', () {
    ...
    test(
      ...
      () {
        ...
        expect(
          SomCEmitter(stamped, versionLabel: 'v0').modelVersionString,
          '1.3',
        );
        expect(
          SomCEmitter(stamped, versionLabel: 'v9').modelVersionString,
          '1.3',
        );
      },
    );
