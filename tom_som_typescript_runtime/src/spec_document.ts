...
export class SpecDocument {
  ...
  /**
   * Drops every value at `prefix` or nested beneath it — content, form entries,
   * list items (with their nested values, ids and counters), and stored
   ...
   * {@link removeListItem}.
   */
  removeValuesUnder(prefix: string): void {
