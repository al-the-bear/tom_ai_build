...
/// (DR15, the JavaScript counterpart of `som_dart_meta_emitter.dart` /
...
/// surfaces of DR1 §4 — the **dot-notation tree** (member names, §4.1) and the
/// **ID-tree** (section ids, §4.2). This module replaces the retired flat
