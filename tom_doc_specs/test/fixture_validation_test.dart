...
void main() {
  ...
  group('minimal schema', () {
    ...
    test('error: overview missing — message includes prefix hint', () {
      final errors = validate(sf, doc(schemaId: 'minimal/1.0', sections: []));
  ...
  group('all-optional schema', () {
    ...
    test('valid: empty document (all optional)', () {
      final errors = validate(
        sf,
        doc(schemaId: 'all-optional/1.0', sections: []),
      );
      expect(errorsOf(errors, ValidationErrorCategory.structure), isEmpty);
    });
  ...
  group('nesting-depth schema', () {
    ...
    test('error: exceeds max depth', () {
                ...
                sec(
                  ...
                  sections: [
                    sec(
                      ...
                      type: 'topic',
                      name: 'L2',
                      sections: [sec(id: 'top-004', type: 'topic', name: 'L3')],
                    ),
                  ],
                ),
              ],
      ...
      final depthErrors = errorsOf(
        errors,
        ValidationErrorCategory.nestingDepth,
      );
  ...
  group('subsection-counts schema', () {
    ...
    test('error: below min subsection count', () {
      final errors = validate(
        ...
        doc(
          schemaId: 'subsection-counts/1.0',
          sections: [
            sec(id: 'par-001', type: 'parent', name: 'Parent', sections: []),
          ],
        ),
      );
      final countErrors = errorsOf(errors, ValidationErrorCategory.countLimit);
    ...
    test('error: exceeds max subsection count', () {
      ...
      expect(
        countErrors.any(
          (e) => e.message.contains('note') || e.message.contains('2'),
        ),
        isTrue,
      );
    });
  ...
  group('form-types schema', () {
    ...
    test('error: missing required form field', () {
      ...
      expect(formatErrors, isNotEmpty);
      expect(
        formatErrors.any((e) => e.message.toLowerCase().contains('email')),
        isTrue,
      );
    });
    ...
    test('error: form field pattern mismatch', () {
      ...
      expect(formatErrors, isNotEmpty);
      expect(
        formatErrors.any((e) => e.message.toLowerCase().contains('pattern')),
        isTrue,
      );
    });
  });
          ...
          sections: [
            ...
            sec(
              ...
              sections: [
                ...
                sec(id: 'child-002', name: 'Child B', fields: {'name': 'beta'}),
              ],
            ),
          ],
        ),
    ...
    test('error: chapter missing required paragraph children', () {
      final errors = validate(
        ...
        doc(
          schemaId: 'child-types/1.0',
          sections: [
            sec(id: 'chap-001', type: 'chapter', name: 'Chapter', sections: []),
          ],
        ),
      );
      final countErrors = errorsOf(errors, ValidationErrorCategory.countLimit);
        ...
        doc(
          ...
          sections: [
            sec(
              ...
              name: 'Overview',
              text:
                  'This is a comprehensive overview of the project that meets the minimum length.',
            ),
            sec(
              id: 'REQ-001',
              type: 'requirement',
        ...
        doc(
          ...
          sections: [
            ...
            sec(
              ...
              name: 'Body',
              text:
                  'This is the body section with more than fifty characters. It Contains uppercase letters.',
            ),
            sec(
              id: 'code-001',
              type: 'code',
        ...
        doc(
          ...
          sections: [
            ...
            sec(
              ...
              name: 'Body',
              text:
                  'This is a valid body section with enough text and Uppercase letters present.',
            ),
            sec(
              id: 'code-001',
              type: 'code',
  ...
  group('empty-document schema', () {
    ...
    test('valid: empty document with no sections required', () {
      final errors = validate(
        sf,
        doc(schemaId: 'empty-document/1.0', sections: []),
      );
      expect(errorsOf(errors, ValidationErrorCategory.structure), isEmpty);
    });
  });
  ...
  group('schema loading from fixture files', () {
    ...
    test('form-types schema has correct field definitions', () {
      ...
      expect(
        form.fields.any((f) => f.fieldname == 'name' && f.required == true),
        isTrue,
      );
      expect(
        form.fields.any((f) => f.fieldname == 'email' && f.required == true),
        isTrue,
      );
      expect(
        form.fields.any((f) => f.fieldname == 'phone' && f.required == false),
        isTrue,
      );
    });
    ...
    test('subsection-positions schema has declarations', () {
      ...
      expect(
        schema.subsectionDeclarations!['main']!['summary']?.position,
        equals('first'),
      );
      expect(
        schema.subsectionDeclarations!['main']!['detail']?.position,
        equals('last'),
      );
    });
  });
  ...
  group('edge cases', () {
    test('no schema declaration reports error', () {
      ...
      final declErrors = errorsOf(
        errors,
        ValidationErrorCategory.schemaDeclaration,
      );
