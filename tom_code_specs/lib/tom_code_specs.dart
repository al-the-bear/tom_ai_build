...
///
/// This is the code home for CodeSpecs — the `Cs*` **annotation family** and
/// the code-side DocSpecs↔CodeSpecs link annotations (`@CodeSpec`, `@DocSpec` /
/// `DocRef`, `codespecs_mapping.md` §9.3). It is a **code framework, not a
