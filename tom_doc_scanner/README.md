...
DocScanner is a standalone package:
...
```bash
# Scan a single file
dart run tom_doc_scanner:doc_scanner scandocument README.md

# Scan multiple files
dart run tom_doc_scanner:doc_scanner scandocuments doc1.md doc2.md -target=output

# Scan a directory tree
dart run tom_doc_scanner:doc_scanner scantree doc/ -target=json-output

# Flatten output (all files in one directory)
dart run tom_doc_scanner:doc_scanner scantree doc/ -flat -target=all-json
```
