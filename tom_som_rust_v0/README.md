...
Generated typed TomSpecs object model (v1.0.0) for Rust. An editing facade over the generic `tom_som_rust_runtime`; regenerate with `tom_specs_clitool/bin/generate_som.dart`.
