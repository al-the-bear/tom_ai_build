...
class SomDartMetaEmitter {
  ...
  String generateLibrary() {
    final b = StringBuffer()
      ..writeln(
        '// GENERATED by tom_specs_clitool SomDartMetaEmitter '
      ...
      ..writeln()
      ..writeln(
        "import 'package:tom_som_dart_runtime/"
  ...
  void _emitCxHelper(StringBuffer b) {
    b
      ...
      ..writeln(
        "/// bridge's cycle rule: a class already on the descent "
        '[stack]',
      )
      ...
      ..writeln(
        '    SomMetaNode Function(bool recursive, '
  ...
  void _emitRoot(StringBuffer b, SpecRoot root) {
    ...
    args.add(
      'document: SomDocMeta(name: ${_str(root.title)}, '
    ...
    b
      ...
      ..writeln(
        'final SomMetaTree ${camel}MetaTree = '
  ...
  void _emitRootRegistry(StringBuffer b) {
    b
      ...
      ..writeln()
      ..writeln(
        '/// One document root of this model: its class name and '
        'section id, its',
      )
      ..writeln(
        '/// populated metadata tree, and the two access roots '
        '(SOM §8) bound to it.',
      )
      ...
      ..writeln('')
      ..writeln(
        '  /// The path segment the two access roots are bound at — '
        'the root section',
      )
      ...
      ..writeln(
        '      this.type, this.segment, this.tree, this.nav, '
        'this.id);',
      )
      ..writeln('}')
      ..writeln()
      ...
      ..writeln(
        '/// in model order. Emitted from the same root list that '
        'produced the trees',
      )
      ..writeln(
        '/// and access roots above, so enumerating this map is '
        'equivalent to reading',
      )
      ..writeln(
        '/// the generator input — no consumer needs a hand-kept '
        'copy of the root set.',
      )
      ..writeln(
        'final Map<String, SomMetaRootEntry> somMetaRoots = '
    ...
    for (final root in _roots) {
      ...
      final camel = _camel(root.type);
      b.writeln(
        '  ${_str(root.type)}: SomMetaRootEntry(${_str(root.type)}, '
  ...
  /// guarded anyway).
  String _escapeSeg(String seg) => seg
      .replaceAll(r'\', r'\\')
      .replaceAll("'", r"\'")
      .replaceAll(r'$', r'\$');
  ...
  void _emitIdClass(StringBuffer b, SpecClass cls) {
    b
      ...
      ..writeln(
        '/// id (`-` → `_`), hoisted through id-less members so '
        'every reachable id is',
      )
      ..writeln(
        '/// one step. `.path` and `.meta` agree with the '
