  ...
  group('SomPythonEmitter', () {
    ...
    test(
      ...
      () {
        ...
        expect(
          SomPythonEmitter(stamped, versionLabel: 'v0').modelVersionString,
          '1.3',
        );
        expect(
          SomPythonEmitter(stamped, versionLabel: 'v9').modelVersionString,
          '1.3',
        );
      },
    );
    ...
    test('colliding form-class names are disambiguated (no duplicates)', () {
      ...
      expect(
        source,
        contains('class MigrationRisksGovernanceContentForm(SomNode)'),
      );
      expect(
        source,
        contains('class MigrationRisksGovernanceContentForm2(SomNode)'),
      );
    });
    ...
    test('a pattern-bearing list emits its @SectionIdPattern; a scalar list '
      ...
      expect(
        RegExp(
          r'def risks\(self\):[\s\S]*?SomList\(self\.doc,[\s\S]*?'
    ...
    test('documentRoots subsets the generated classes', () {
      ...
      final justRoot = SomPythonEmitter(
        _fixtureModel(),
