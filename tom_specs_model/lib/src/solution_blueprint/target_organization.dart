...
@StandardReferences(
  ['BABOK v3 — future-state analysis', 'McKinsey 7-S — organizational design'],
...
class ChangesFromCurrentStructure extends DocSpecsSection {
  ...
  @ContentHelp(
    'Provide narrative description of the organizational '
...
@StandardReferences(
  ['BABOK v3 — future-state analysis', 'PROSCI ADKAR — change management'],
...
class OrganizationalChangeEntry extends DocSpecsSection {
  ...
  @Form([
    ...
    Field(
      'reportingLineImpact',
      String,
      'Reporting Line Impact',
      hint: 'Changes to who reports to whom',
    ),
    Field(
      'decisionRightsImpact',
      String,
      'Decision Rights Impact',
  ...
  @SectionId('OCTRS')
  @StandardReferences(
    ['Kotter 8-Step — leading change', 'ISO/IEC/IEEE 29148 §6 — transition'],
  ...
  @StandardReferences(
    ['ISO 31000 — risk management', 'PROSCI ADKAR — change management'],
  ...
  @ContentHelp(
    'Add one entry per risk associated with this change, each with '
...
class OrganizationalTransitionTimeline extends DocSpecsSection {
  ...
  @StandardReferences(
    ['ISO/IEC/IEEE 29148 §6 — transition', 'PMBOK — schedule management'],
  ...
  @StandardReferences(
    ['PMBOK — schedule management', 'ITIL 4 — service transition'],
...
@StandardReferences(
  ['PROSCI ADKAR — change management', 'Kotter 8-Step — leading change'],
...
class TransitionOverview extends DocSpecsSection {
  @Form([
    Field(
      ...
      hint:
          'Overall approach to the transition: phased rollout, big-bang '
          'cutover, parallel run, or pilot-first',
    ),
    Field(
      'changeManagementMethodology',
      String,
      'Change Management Methodology — PROSCI ADKAR, Kotter, Lewin, custom',
      hint:
          'The change-management framework guiding the transition: PROSCI '
    ...
    Field(
      ...
      hint:
          'The target date by which the transition should be fully '
          'complete',
    ),
  ])
  @override
  ...
  @SectionId('TROML')
  @StandardReferences(
    ['ISO/IEC/IEEE 29148 §6 — transition', 'ITIL 4 — service transition'],
  ...
  @Form([
    Field(
      ...
      hint:
          'Total expected duration of the transition, expressed in weeks '
          'or months',
    ),
    Field(
      ...
      hint:
          'How long old and new processes run side by side before the old '
          'ones are retired',
    ),
    Field(
      'cutoverStrategy',
      ...
      hint:
          'How the go-live moment is planned and executed, including '
    ...
    Field(
      ...
      hint:
          'The fallback procedure to revert to the prior state if the '
          'transition fails',
    ),
  ])
  @SerializationOrder(1)
  ...
  @SectionId('TROGV')
  @StandardReferences(
    ['PMBOK — resource management', 'PROSCI ADKAR — change management'],
  ...
  @Form([
    Field(
      ...
      hint:
          'The oversight structure and where decision authority sits for '
          'the transition',
    ),
    Field(
      'transitionOwner',
      ...
      hint:
          'The single person or role accountable for the overall '
          'transition',
    ),
    Field(
      'changeChampions',
      ...
      hint:
          'The advocates within each affected area who champion the change '
...
@StandardReferences(
  ['PMBOK — schedule management', 'PROSCI ADKAR — change management'],
...
class TransitionPhaseEntry extends DocSpecsSection {
  ...
  @Form([
    Field(
      ...
      hint:
          'The conditions that must be satisfied for the phase to be '
          'considered complete',
    ),
    Field(
      'signOffRequired',
    ...
    Field(
      'knownIssuesResolution',
      String,
      'Known Issues Resolution — outstanding items allowed',
      hint:
          'Which outstanding items are permitted to remain unresolved at '
          'phase exit',
    ),
  ])
  @SerializationOrder(3)
...
/// Phase identification and timeline.
@StandardReferences(
  ['PMBOK — schedule management', 'ISO/IEC/IEEE 29148 §6 — transition'],
...
class TransitionPhaseIdentification extends DocSpecsSection {
  @Form([
    Field(
      ...
      hint:
          'The kind of phase: Preparation, Pilot, Rollout, '
  ...
  @SectionId('TPISC')
  @StandardReferences(
    ['ISO/IEC/IEEE 29148 §6 — transition', 'PMBOK — resource management'],
  ...
  @Form([
    Field(
      ...
      hint:
          'The sites or regions that fall within the scope of this '
          'phase',
    ),
    Field(
      'affectedDepartments',
      ...
      hint:
          'The organizational units or departments impacted by this '
          'phase',
    ),
    Field(
      'affectedUserCount',
...
class TransitionPhaseActivities extends DocSpecsSection {
  @Form([
    ...
    Field(
      ...
      hint:
          'The training sessions or materials to be delivered in this '
          'phase',
    ),
    Field(
      ...
      hint:
          'The announcements, meetings, and other communications planned '
          'for this phase',
    ),
    Field(
      'systemActivities',
      ...
      hint:
          'The technical preparations and data-migration work required in '
          'this phase',
    ),
    Field(
      'processActivities',
    ...
    Field(
      'deliverables',
      String,
      'Phase Deliverables — outputs to produce',
...
class TransitionPhaseStakeholders extends DocSpecsSection {
  @Form([
    ...
    Field(
      ...
      hint:
          'The mechanism used to collect stakeholder input during this '
          'phase',
    ),
    Field(
      'escalationPath',
...
class TransitionMilestoneEntry extends DocSpecsSection {
  @Form([
    Field(
      ...
      hint:
          'The kind of milestone: Decision Gate, Checkpoint, Go-Live, or '
          'Closure',
    ),
    Field(
      'targetDate',
    ...
    Field(
      ...
      hint:
          'Current status of the milestone: Planned, On Track, At Risk, '
          'Delayed, or Achieved',
    ),
    Field(
      'description',
  ...
  @SectionId('TMLGV')
  @StandardReferences(
    ['PMBOK — schedule management', 'PMBOK — resource management'],
  ...
  @Form([
    Field(
      'deliverables',
      String,
      'Deliverables — required for milestone',
      hint:
          'The deliverables that must be in place for the milestone to '
          'be reached',
    ),
    Field(
      'decisionRequired',
      ...
      hint:
          'The Go/No-Go or other decision that must be made at this '
          'milestone',
    ),
    Field(
      'decisionOwner',
      ...
      'Decision Owner',
      hint:
          'The person or role accountable for making the decision at '
          'this milestone',
    ),
  ])
  @SerializationOrder(1)
  ...
  @SectionId('TMED')
  @StandardReferences(
    ['PMBOK — schedule management', 'ISO 31000 — risk management'],
  ...
  @Form([
    Field(
      ...
      hint:
          'The phases that must complete before this milestone can be '
          'achieved',
    ),
    Field(
      'dependsOnMilestones',
      ...
      hint:
          'The prior milestones required before this milestone can be '
          'reached',
    ),
    Field(
      'criticality',
  ...
  @Form([
    Field(
      ...
      hint:
          'The recognition or celebration activities planned for '
...
class ChangeReadinessAssessment extends DocSpecsSection {
  ...
  @Form([
    Field(
      ...
      hint:
          'The techniques used to assess readiness: surveys, interviews, '
    ...
    Field(
      ...
      hint:
          'How frequently readiness is re-evaluated, e.g. weekly, per '
    ...
    Field(
      ...
      hint:
          'The person or role accountable for tracking and reporting '
          'change readiness',
    ),
    Field(
      'minimumReadinessLevel',
      String,
      'Minimum Readiness Level — threshold to proceed',
      hint:
          'The minimum readiness score or level required before the '
    ...
    Field(
      ...
      hint:
          'The conditions under which readiness concerns must be '
    ...
    Field(
      ...
      hint:
          'The tools, survey platforms, or instruments used to collect '
    ...
    Field(
      ...
      hint:
          'Which ADKAR dimensions (Awareness, Desire, Knowledge, Ability, '
...
class ReadinessCriteriaEntry extends DocSpecsSection {
  @Form([
    Field(
      ...
      required: true,
      hint:
          'The stakeholder group whose change readiness this entry '
          'assesses',
    ),
    Field(
      'awarenessLevel',
      ...
      hint:
          'The group\'s level of awareness of the change, rated 1 (none) '
          'to 5 (full understanding)',
    ),
    Field(
      'desireLevel',
      String,
      'Desire Level — willingness to participate (1-5)',
      hint:
          'The group\'s willingness to participate in the change, rated 1 '
    ...
    Field(
      ...
      hint:
          'The skills and knowledge the group has acquired to operate in '
    ...
    Field(
      ...
      hint:
          'The group\'s demonstrated capability to perform in the new '
          'state, rated 1 to 5',
    ),
    Field(
      'reinforcementNeeded',
      ...
      hint:
          'The reinforcement or ongoing support required to sustain the '
    ...
    Field(
      ...
      hint:
          'The specific barriers, concerns, or sources of resistance to '
    ...
    Field(
      ...
      hint:
          'The actions planned to address the identified resistance '
    ...
    Field(
      ...
      hint:
          'The overall readiness status of the group: Ready, Needs Work, '
...
/// Communication plan for the transition.
@StandardReferences(
  ['PMBOK — communications management', 'PROSCI ADKAR — change communications'],
...
class TransitionCommunicationPlan extends DocSpecsSection {
  ...
  @Form([
    Field(
      ...
      hint:
          'The overarching approach to transition communications, '
    ...
    Field(
      ...
      hint:
          'The core messages to be reinforced consistently across all '
    ...
    Field(
      ...
      hint:
          'The person or role that owns and approves the content of all '
    ...
    Field(
      ...
      hint:
          'The mechanisms through which stakeholders can ask questions, '
    ...
    Field(
      ...
      hint:
          'How often transition updates are issued, e.g. weekly digests '
    ...
    Field(
      ...
      hint:
          'The visual identity, naming, and branding standards applied to '
    ...
    Field(
      ...
      hint:
          'The languages and translation requirements needed to reach all '
          'affected audiences',
    ),
    Field(
      ...
      hint:
          'The accessibility considerations (formats, captions, screen '
...
class CommunicationEventEntry extends DocSpecsSection {
  @Form([
    Field(
      ...
      hint:
          'The kind of communication event: Announcement, Town Hall, '
    ...
    Field(
      ...
      'Target Audience',
      hint:
          'The stakeholder group or audience this event is intended to '
          'reach',
    ),
    Field(
      'scheduledDate',
      ...
      'Scheduled Date',
      hint:
          'The date on which this communication event is scheduled to '
          'occur',
    ),
    Field(
      'phase',
      String,
      'Phase — which transition phase',
    ...
    Field(
      ...
      hint:
          'The specific messages this particular event is designed to '
          'convey',
    ),
  ])
  @override
  ...
  @Form([
    Field(
      ...
      hint:
          'The channel or medium through which this event is '
          'delivered, e.g. email, intranet, in-person',
    ),
    Field(
      'owner',
      String,
      'Owner — who prepares/delivers',
      hint:
          'The person or role responsible for preparing and '
          'delivering this event',
    ),
    Field(
      'approver',
      String,
      'Approver — who approves content',
      hint:
          'The person or role who must approve the content before it '
          'is delivered',
    ),
    Field(
      'materialsRequired',
      String,
      'Materials Required — slides, scripts, etc.',
      hint:
          'The materials needed to deliver this event, such as slides, '
  ...
  @SectionId('CEEO')
  @StandardReferences(
    ['PMBOK — communications management', 'PROSCI — adoption metrics'],
  ...
  @Form([
    Field(
      ...
      hint:
          'The actions to be taken after the event, such as sharing '
          'recordings or following up on questions',
    ),
    Field(
      'successMeasure',
      String,
      'Success Measure — how effectiveness is measured',
      hint:
          'How the effectiveness of this communication event is '
          'measured, e.g. attendance, survey scores, reach',
    ),
    Field(
      'status',
      String,
      'Status — Planned, In Preparation, Delivered, Cancelled',
      hint:
          'The current status of this event: Planned, In Preparation, '
...
class TransitionCommunicationChannels extends DocSpecsSection {
  @Form([
    Field(
      ...
      hint:
          'The main channels used for routine transition communications, '
    ...
    Field(
      ...
      hint:
          'The channels reserved for time-sensitive or urgent '
    ...
    Field(
      ...
      hint:
          'The channels enabling two-way communication so stakeholders '
    ...
    Field(
      ...
      hint:
          'The location where communication materials and documentation '
    ...
    Field(
      ...
      hint:
          'Which audiences can access each channel and any access '
...
class TransitionSupportStructure extends DocSpecsSection {
  ...
  @Form([
    Field(
      ...
      hint:
          'How transition support is organized: tiered help desk, buddy '
    ...
    Field(
      ...
      hint:
          'The hours and days during which transition support is '
          'available to users',
    ),
    Field(
      'supportChannels',
      ...
      hint:
          'The channels through which users can reach support: help desk, '
    ...
    Field(
      ...
      hint:
          'The expected support volumes and the staffing provisioned to '
          'meet them',
    ),
    Field(
      'supportDuration',
      ...
      hint:
          'How long the period of enhanced transition support will last '
          'before scaling back',
    ),
    Field(
      'transitionToBAU',
      ...
      hint:
          'When and how support hands over to the business-as-usual '
    ...
    Field(
      ...
      hint:
          'The self-service resources (FAQs, guides, knowledge base) '
          'available to users',
    ),
    Field(
      'superUserNetwork',
      ...
      hint:
          'The network of local super-users or champions who provide '
...
class TransitionSupportResourceEntry extends DocSpecsSection {
  @Form([
    Field(
      ...
      required: true,
      hint:
          'The kind of support resource: Help Desk, Super User, Floor '
    ...
    Field(
      ...
      hint:
          'The start and end dates during which this resource is '
          'available',
    ),
    Field(
      'coverage',
      String,
      'Coverage — locations/departments covered',
    ...
    Field(
      'capacity',
      String,
      'Capacity — how many can be supported',
    ...
    Field(
      'owner',
      String,
      'Owner — who manages this resource',
    ...
    Field(
      ...
      hint:
          'The cost center or budget against which this resource is '
          'allocated',
    ),
  ])
  @override
...
class TransitionEscalationPaths extends DocSpecsSection {
  @Form([
    Field(
      ...
      hint:
          'The first-line support tier that handles initial user '
          'requests',
    ),
    Field(
      'level2',
      ...
      hint:
          'The specialist support tier that issues escalate to from '
          'first-line',
    ),
    Field(
      'level3',
      String,
      'Level 3 — expert/vendor support',
      hint:
          'The expert or vendor support tier for issues that specialists '
          'cannot resolve',
    ),
    Field(
      'emergencyContact',
      ...
      hint:
          'The contact to use for critical or emergency issues requiring '
          'immediate attention',
    ),
    Field(
      'escalationCriteria',
      ...
      hint:
          'The conditions that determine when an issue must be escalated '
          'to the next level',
    ),
    Field(
      'responseTimeTargets',
      ...
      hint:
          'The target response times for each severity level of support '
          'issue',
    ),
    Field(
      ...
      hint:
          'The path for escalating organizational or non-technical issues '
          'to management',
    ),
  ])
  @override
...
@StandardReferences(
  ['PMBOK — monitoring & controlling', 'PROSCI — adoption metrics'],
...
class TransitionSuccessMetrics extends DocSpecsSection {
  ...
  @Form([
    Field(
      ...
      hint:
          'The overall approach to evaluating transition success, '
    ...
    Field(
      ...
      hint:
          'How often metrics are compiled and reported, e.g. weekly, '
    ...
    Field(
      ...
      hint:
          'The person or role responsible for producing the metrics '
          'reports',
    ),
    Field(
      'reportingAudience',
      ...
      hint:
          'The audience who receives the metrics reports, e.g. steering '
    ...
    Field(
      ...
      hint:
          'The period during which the baseline values were established '
          'for comparison',
    ),
    Field(
  ...
  @StandardReferences(
    ['PMBOK — monitoring & controlling', 'ISO/IEC 25010 — quality measurement'],
...
class TransitionMetricEntry extends DocSpecsSection {
  @Form([
    Field(
      ...
      hint:
          'The category of this metric: Adoption, Performance, Quality, '
    ...
    Field(
      ...
      'Measurement Method',
      hint:
          'How this metric is measured, including the data source and '
          'calculation',
    ),
    Field(
      'baseline',
      ...
      'Baseline Value',
      hint:
          'The baseline value of this metric before the transition, used '
  ...
  @Form([
    Field(
      ...
      hint:
          'The minimum acceptable value for this metric below which '
          'action is required',
    ),
    Field(
      'currentValue',
    ...
    Field(
      ...
      hint:
          'How often this metric is measured, e.g. daily, weekly, '
          'monthly',
    ),
    Field(
      'dataSource',
      ...
      'Data Source',
      hint:
          'The system or source from which this metric\'s data is '
          'collected',
    ),
    Field(
      'owner',
      ...
      'Owner',
      hint:
          'The person or role responsible for measuring and reporting '
          'this metric',
    ),
  ])
  @SerializationOrder(1)
  ...
  @Form([
    Field(
      'status',
      String,
      'Status — On Track, At Risk, Below Target, Achieved',
      hint:
          'The current status of this metric: On Track, At Risk, '
    ...
    Field(
      ...
      hint:
          'The direction this metric is trending: Improving, Stable, '
          'or Declining',
    ),
  ])
  @SerializationOrder(2)
...
@StandardReferences(
  ['ISO 31000 — risk management', 'PMBOK — risk management'],
...
class TransitionRiskEntry extends DocSpecsSection {
  @Form([
    Field(
      ...
      hint:
          'The category of this risk: Resistance, Capacity, Timing, '
    ...
    Field(
      ...
      'Description',
      hint:
          'A description of the risk, including what could go wrong and '
  ...
  @Form([
    ...
    Field(
      ...
      'Affected Phases',
      hint:
          'The transition phases that would be affected if this risk '
          'materializes',
    ),
    Field(
      ...
      hint:
          'The signals or indicators that would warn the team this '
          'risk is emerging',
    ),
  ])
  @SerializationOrder(1)
  ...
  @Form([
    Field(
      ...
      'Mitigation Strategy',
      hint:
          'The planned actions to reduce the probability or impact of '
          'this risk',
    ),
    Field(
      'contingencyPlan',
      ...
      'Contingency Plan',
      hint:
          'The fallback plan to execute if this risk materializes '
          'despite mitigation',
    ),
    Field(
      'owner',
      ...
      'Risk Owner',
      hint:
          'The person or role accountable for managing and monitoring '
          'this risk',
    ),
    Field(
      'status',
      ...
      hint:
          'The current status of this risk: Active, Mitigated, '
          'Realized, or Closed',
    ),
  ])
  @SerializationOrder(2)
...
class JobDescriptionsAndStaffing extends DocSpecsSection {
  ...
  @Form([
    ...
    Field(
      'hrPartner',
      String,
      'HR Partner — HR contact for role changes',
...
class StaffingPlan extends DocSpecsSection {
  ...
  @Form([
    Field(
      ...
      String,
      'Staffing Strategy',
      hint: 'Hire / Promote / Contract / Outsource mix — overall approach',
    ),
    Field(
      'sourcingChannels',
      String,
    ...
    Field(
      ...
      String,
      'Selection Process',
      hint: 'Interviews, assessments, background checks — selection steps',
    ),
    Field(
      'onboardingApproach',
      String,
    ...
    Field(
      ...
      hint: 'DEI hiring goals and constraints on sourcing/selection process',
    ),
    Field(
...
class StaffingBudget extends DocSpecsSection {
  ...
  @SectionId('STBUGO')
  @StandardReferences(
    ['PMBOK — cost/resource budgeting', 'RACI — responsibility assignment'],
...
class StaffingEntry extends DocSpecsSection {
  @Form([
    Field(
      ...
      String,
      'Role Title',
      hint: 'Job title for this position',
      required: true,
    ),
    Field(
      'jobFamily',
  ...
  @Form([
    Field('department', String, 'Department', hint: 'Organizational unit'),
    Field(
      'location',
      String,
      'Location',
  ...
  @Form([
    ...
    Field('headcount', int, 'Headcount', hint: 'Number of positions to fill'),
    Field(
      'requiredSkills',
      String,
  ...
  @Form([
    ...
    Field(
      ...
      String,
      'Recruitment Status',
      hint: 'Approved / Posted / Interviewing / Offered / Filled',
    ),
    Field(
      'targetStartDate',
      String,
  ...
  @Form([
    ...
    Field('recruiter', String, 'Recruiter', hint: 'HR point of contact'),
    Field(
      'salaryRange',
      String,
      'Salary Range',
...
/// 5.2.5. Competency Framework.
@StandardReferences(
  ['CIPD — competency frameworks', 'ISO 9001 §7.2 — competence'],
...
class NewRoleEntry extends DocSpecsSection {
  ...
  @SectionId('NEROON')
  @StandardReferences(
    ['SHRM — onboarding', 'CIPD — competency frameworks and people management'],
...
class ResponsibilityDetailEntry extends DocSpecsSection {
  @Form([
    ...
    Field(
      'toolsUsed',
      String,
      'Tools Used — systems/applications',
...
class RoleCompetencyEntry extends DocSpecsSection {
  @Form([
    ...
    Field(
      'preferredLevel',
      String,
      'Preferred Level — ideal proficiency',
...
class ChangedRoleEntry extends DocSpecsSection {
  ...
  @Form([
    Field(
      'incumbentCount',
      int,
      'Incumbent Count — people affected',
...
class ChangedRoleIdentification extends DocSpecsSection {
  @Form([
    Field(
      'newRoleTitle',
      String,
      'New Role Title — if title changes',
  ...
  @Form([
    ...
    Field(
      'incumbentCount',
      int,
      'Incumbent Count — people in this role',
...
class ResponsibilityChangeEntry extends DocSpecsSection {
  @Form([
    ...
    Field(
      'currentState',
      String,
      'Current State — how done today',
      hint: 'How this responsibility is handled before the change',
    ),
    Field(
      'futureState',
      String,
      'Future State — how done after change',
    ...
    Field(
      'toolsAffected',
      String,
      'Tools Affected — systems involved',
...
class ChangedRoleCompetencies extends DocSpecsSection {
  ...
  @SectionId('COGAAS')
  @StandardReferences(
    ['CIPD — competency gap analysis', 'ISO 9001 §7.2 — competence'],
...
class EquipmentRequirements extends DocSpecsSection {
  ...
  @Form([
    ...
    Field('assetTracking', String, 'Asset Tracking — how equipment is tracked'),
    Field(
      'supportModel',
      String,
      'Support Model — warranty, maintenance, break-fix',
    ),
    Field('disposalProcess', String, 'Disposal Process — end-of-life handling'),
    Field(
      'budgetAllocation',
      String,
...
class InputDeviceEntry extends DocSpecsSection {
  @Form([
    ...
    Field('connectivity', String, 'Connectivity — wired, wireless, Bluetooth'),
    Field(
      'specialFeatures',
      String,
...
class MobileDeviceEntry extends DocSpecsSection {
  ...
  @SectionId('MDEP')
  @Form([
    Field('dataCarrier', String, 'Data Carrier — carrier, plan type'),
    Field(
      'accessories',
      String,
...
class SpecializedEquipmentEntry extends DocSpecsSection {
  ...
  @Form([
    ...
    Field('driverSoftware', String, 'Driver/Software — software requirements'),
...
class TechnicalInfrastructure extends DocSpecsSection {
  ...
  @Form([
    ...
    Field('networkSegment', String, 'Network Segment — VLAN, security zone'),
    Field('firewallRules', String, 'Firewall Rules — ports, protocols needed'),
    Field('proxyConfiguration', String, 'Proxy Configuration — if required'),
    Field(
      'dnsRequirements',
      String,
  ...
  @Form([
    ...
    Field('vdiPlatform', String, 'VDI Platform — Citrix, VMware Horizon, AVD'),
    Field(
      'mfaRequirement',
      String,
...
class WorkplaceSoftwareRequirements extends DocSpecsSection {
  ...
  @Form([
    ...
    Field('developmentTools', String, 'Development Tools — if applicable'),
    Field(
      'licenseType',
      String,
...
class CommunicationToolsRequirements extends DocSpecsSection {
  @Form([
    ...
    Field('instantMessaging', String, 'Instant Messaging — chat platform'),
    Field(
      'presenceIndicator',
      String,
...
class TrainingRequirements extends DocSpecsSection {
  ...
  @Form([
    ...
    Field(
      'blendedLearningApproach',
      String,
      'Blended Learning Approach — mix of methods',
    ),
    Field('trainingBudget', String, 'Training Budget — per user, total'),
    Field(
      'trainingTimeline',
      String,
...
class InitialTrainingEntry extends DocSpecsSection {
  ...
  @SectionId('INTRDE')
  @Form([
    Field('format', String, 'Format — classroom, online, hands-on, blended'),
  ...
  @SectionId('INTRSC')
  @Form([
    Field('schedule', String, 'Schedule — when offered relative to go-live'),
...
class OngoingTrainingEntry extends DocSpecsSection {
  ...
  @Form([
    ...
    Field('frequency', String, 'Frequency — annual, quarterly, as-needed'),
...
class SystemTrainingEntry extends DocSpecsSection {
  ...
  @SectionId('STEF')
  @Form([
    Field('functionalScope', String, 'Functional Scope — functions covered'),
    Field(
      'taskBasedLearning',
      String,
  ...
  @Form([
    ...
    Field('helpResources', String, 'Help Resources — where to get help'),
    Field(
      'sandboxEnvironment',
      String,
...
class CertificationEntry extends DocSpecsSection {
  ...
  @SectionId('CEENSU')
  @Form([
    Field('companySponsored', String, 'Company Sponsored — paid by company'),
    Field(
      'studyTimeAllotted',
      String,
...
class TrainingMaterials extends DocSpecsSection {
  ...
  @Form([
    ...
    Field('cheatSheets', String, 'Cheat Sheets — shortcuts, tips'),
    Field(
      'processFlowcharts',
      String,
  ...
  @SectionId('TRMAKN')
  @Form([
    Field('knowledgeBase', String, 'Knowledge Base — searchable help articles'),
  ...
  @Form([
    ...
    Field('translationNeeds', String, 'Translation Needs — languages required'),
    Field(
      'accessibilityFormat',
      String,
...
class TrainingAssessment extends DocSpecsSection {
  @Form([
    ...
    Field('preAssessment', String, 'Pre-Assessment — baseline knowledge check'),
    Field('postAssessment', String, 'Post-Assessment — end-of-training test'),
    Field(
      'practicalEvaluation',
      String,
  ...
  @Form([
    ...
    Field('gapAnalysis', String, 'Gap Analysis — identifying remaining gaps'),
...
class WorkplaceSupportResources extends DocSpecsSection {
  @Form([
    ...
    Field('helpDeskHours', String, 'Help Desk Hours — support availability'),
    Field('escalationPath', String, 'Escalation Path — how issues escalate'),
    Field(
      'onSiteSupport',
      String,
  ...
  @SectionId('WSRC')
  @Form([
    Field('remoteSupport', String, 'Remote Support — remote troubleshooting'),
    Field(
      'superUserNetwork',
      String,
