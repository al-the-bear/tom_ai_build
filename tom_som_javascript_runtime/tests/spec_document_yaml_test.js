 ...
 * `tom_som_python_runtime/tests/spec_document_yaml_test.py` (itself a port of
 ...
 *
 * Run with: `node tests/spec_document_yaml_test.js`. Exit code 0 == green.
 */
...
function _throwsFormat(fn, contains = '') {
  try {
    fn();
    return false;
  } catch (e) {
...
function testClassLevelOnlyKey() {
