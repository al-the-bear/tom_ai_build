...
/// `tom_som_typescript_runtime` `SpecDocument`: every typed accessor delegates
...
class SomTypeScriptEmitter {
  ...
  String generateLibrary() {
    ...
    final buffer = StringBuffer()
      ..writeln(
        '// GENERATED by tom_specs_clitool SomTypeScriptEmitter '
      ...
      ..writeln('//')
      ..writeln(
        '// The generic runtime is imported through a fixed bare '
        'specifier; the generator',
      )
      ..writeln(
        '// wires resolution by writing a `package.json` `file:` '
        'dependency on the runtime',
      )
      ..writeln(
        '// and a `tsconfig.json`, so this module carries no on-disk '
        'path of its own.',
      )
      ..writeln("import {")
      ...
      ..writeln(
        '// below, so one import of this facade surfaces both '
        'access styles.',
      )
      ..writeln(
        "import * as _meta from "
  ...
  String _emitClass(
    ...
    if (isRoot) {
      ...
      b
        ...
        ..writeln(
          '  static readonly MODEL_VERSION: string = '
          '"$modelVersionString";',
        )
        ..writeln()
        ..writeln(
        ...
        ..writeln(
          '  static editabilityFor(documentVersion: string | null): '
          'SomEditability {',
        )
        ..writeln(
