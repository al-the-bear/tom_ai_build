...
class OrganizationStructure extends DocSpecsSection {
  ...
  @ContentHelp(
    'Insert project organization chart showing reporting lines. '
...
class GovernanceModel extends DocSpecsSection {
  ...
  @ContentHelp(
    'Add one entry per decision area, naming its authority level, '
...
@ContentHelp(
  'List all steering committee members with their roles, '
...
@ContentHelp(
  'Document each committee member with their organizational role, '
...
class CommitteeMemberEntry extends DocSpecsSection {
  ...
  @ContentHelp(
    'Add one entry per responsibility area this member owns, with '
...
class CommitteeResponsibilityEntry extends DocSpecsSection {
  @Form([
    ...
    Field('scope', String, 'Scope', hint: 'Boundaries of this responsibility'),
    Field(
      'escalationTo',
      String,
      'Escalation To',
...
@ContentHelp(
  'Document all team members assigned to the project with their '
...
class ProjectTeamStaffing extends DocSpecsSection {
  ...
  @Min(1)
  @ContentHelp(
    'Add one entry per assigned team member, with their role, '
  ...
  @ContentHelp(
    'Add one entry per unfilled position, with its required skills, '
...
class TeamStructureOverview extends DocSpecsSection {
  @Form([
    ...
    Field(
      'teamLocationModel',
      String,
      'Location Model (Co-located/Distributed/Hybrid)',
...
@ContentHelp(
  'Document each team member with their role, allocation, skills, '
...
class TeamMemberEntry extends DocSpecsSection {
  ...
  @Form([
    ...
    Field('timeZone', String, 'Time Zone', hint: 'Their working time zone'),
    Field(
      'contactEmail',
      String,
      'Contact Email',
...
class TeamMemberSkills extends DocSpecsSection {
  ...
  @ContentHelp(
    'Add one entry per individual skill, with its proficiency level, '
...
''')
  ...
  @ContentHelp(
    'Add one entry per custom distribution group, capturing its '
...
class CommunicationMatrix extends DocSpecsSection {
  @Form([
    Field(
      ...
      hint:
          'Primary channel for project communications — Email / Portal / Teams',
    ),
    Field(
      'documentRepository',
      String,
  ...
  @ContentType(
    'mermaid',
    'Diagram showing communication flows between '
  ...
  @ContentHelp(
    'Add one entry per communication type, capturing its frequency, '
...
class CommunicationTypeEntry extends DocSpecsSection {
  @Form([
    Field(
      ...
      'Communication Type',
      hint:
          'Type of communication — StatusReport / MilestoneAlert / IssueNotification / MeetingMinutes / ChangeRequest',
      required: true,
    ),
    Field(
      'description',
...
class CustomDistributionGroup extends DocSpecsSection {
  ...
  @ContentHelp(
    'Add one entry per recipient in this group, capturing their '
...
''')
  ...
  @ContentHelp(
    'Add one entry per full-distribution recipient, capturing their '
    'role, contact information, preferences, and access levels.',
  )
  @SerializationOrder(2)
...
''')
  ...
  @SectionIdPattern('DSRC-ITEM-xxx')
  @ContentHelp(
    'Add one entry per executive-summary recipient, capturing their '
    'role, contact information, preferences, and access levels.',
  )
  @SerializationOrder(2)
  List<DistributionRecipientEntry> items = [];
...
class DistributionRecipientEntry extends DocSpecsSection {
  ...
  @Form([
    Field('jobTitle', String, 'Job Title', hint: "Recipient's job title"),
    Field(
      'primaryEmail',
      String,
      'Primary Email',
  ...
  @ContentHelp(
    'Add one entry per preference set, capturing the distribution '
...
''')
  ...
  @Form([
    ...
    Field(
      'retroactiveChangePolicy',
      String,
      'Retroactive Change Policy',
  ...
  @ContentHelp(
    'Add one entry per change category, capturing its scope, '
...
''')
  ...
  @ContentHelp(
    'Add one entry per step in the change process, in execution '
  ...
  @ContentHelp(
    'Add one entry per role involved in the change process, '
  ...
  @Form([
    ...
    Field(
      'scheduleImpactWeight',
      int,
      'Schedule Impact Weight',
      hint: 'Weight for schedule impact — 0-100',
    ),
    Field(
      'budgetImpactWeight',
      int,
      'Budget Impact Weight',
      hint: 'Weight for budget impact — 0-100',
    ),
    Field(
      'qualityImpactWeight',
      int,
      'Quality Impact Weight',
  ...
  @ContentHelp(
    'Add one entry per notification rule, capturing who is '
...
class ChangeRoleEntry extends DocSpecsSection {
  @Form([
    ...
    Field('backup', String, 'Backup', hint: 'Backup person for this role'),
    Field(
...
''')
  ...
  @ContentHelp(
    'Add one entry per impact-level definition set, mapping each '
  ...
  @ContentHelp(
    'Add one entry per impact criterion, capturing its thresholds, '
...
''')
  ...
  @Form([
    ...
    Field('meetingTime', String, 'Meeting Time', hint: 'Standard meeting time'),
    Field(
      'meetingDuration',
      String,
      'Meeting Duration',
  ...
  @ContentHelp(
    'Add one entry per Change Control Board member, capturing their '
...
class ChangeCategoryEntry extends DocSpecsSection {
  ...
  @Form([
    Field(
      ...
      'Scope',
      hint:
          'What is affected — Scope / Schedule / Budget / Quality / Technical',
    ),
    Field(
      'examples',
      String,
...
@ContentHelp(
  'Document any additional administrative requirements not covered '
...
class LegalAndContractualRequirements extends DocSpecsSection {
  ...
  @ContentHelp(
    'Add one entry per additional agreement, capturing its title, '
...
@ContentHelp(
  'Specify who owns intellectual property created during the project, '
...
class IntellectualPropertyRequirements extends DocSpecsSection {
  @Form([
    Field(
      ...
      'Ownership Model',
      required: true,
      hint: 'How IP ownership is allocated between parties',
    ),
    Field(
      'preExistingIp',
      String,
  ...
  @ContentHelp(
    'Add one entry per IP asset, capturing its type, description, '
...
class IpOwnershipEntry extends DocSpecsSection {
  @Form([
    ...
    Field('assetDescription', String, 'Description', hint: 'What the asset is'),
    Field('owner', String, 'Owner', hint: 'Party that owns the asset'),
    Field(
      'usageRights',
      String,
      'Usage Rights',
...
@ContentHelp(
  'Document all NDA and confidentiality requirements, including '
...
class ConfidentialityRequirements extends DocSpecsSection {
  ...
  @ContentHelp(
    'Add one entry per category of confidential information, '
...
@ContentHelp(
  'List all regulatory requirements the project must comply with, '
...
class RegulatoryComplianceRequirements extends DocSpecsSection {
  ...
  @ContentHelp(
    'Add one entry per regulation the project must comply with, '
  ...
  @ContentHelp(
    'Add one entry per compliance milestone, capturing its related '
...
@ContentHelp(
  'Document audit requirements including scope, frequency, '
...
class AuditRequirements extends DocSpecsSection {
  ...
  @ContentHelp(
    'Add one entry per planned audit, capturing its type, auditor, '
...
class AuditEntry extends DocSpecsSection {
  @Form([
    ...
    Field('scope', String, 'Scope', hint: 'What the audit covers'),
    Field(
      'plannedDate',
      String,
      'Planned Date',
    ...
    Field('frequency', String, 'Frequency', hint: 'How often the audit recurs'),
    Field(
      'standards',
      String,
...
class AuditEvidenceRequirements extends DocSpecsSection {
  ...
  @ContentHelp(
    'Add one entry per type of audit evidence, capturing its '
...
@ContentHelp(
  'Document insurance requirements and liability limitations '
...
class InsuranceLiabilityRequirements extends DocSpecsSection {
  ...
  @ContentHelp(
    'Add one entry per insurance coverage, capturing its type, '
  ...
  @ContentHelp(
    'Add one entry per liability limitation, capturing its maximum '
...
class OtherAgreementEntry extends DocSpecsSection {
  @Form([
    ...
    Field('parties', String, 'Parties', hint: 'Parties bound by the agreement'),
    Field(
      'effectiveDate',
      String,
      'Effective Date',
