...
Generated typed TomSpecs object model (v1.0.0) for Dart. An editing facade over the generic `tom_som_dart_runtime`; regenerate with `tom_specs_clitool/bin/generate_som.dart`.
