...
Generated typed TomSpecs object model (v1.1.0) for C++. An editing facade over the generic `tom_som_cpp_runtime`; regenerate with `tom_specs_clitool/bin/generate_som.dart`.
