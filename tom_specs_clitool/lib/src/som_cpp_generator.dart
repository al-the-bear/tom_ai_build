...
/// static library on demand, and archives the generated translation unit into
/// `build/libtom_som_cpp_v0.a`. The emitted C++ source carries no on-disk path
/// and stays layout-independent / golden-stable.
library;
...
String _makefile(String runtimeRel) {
  ...
  return '# GENERATED by tom_specs_clitool SomCppGenerator — do not edit by hand.\n'
      ...
      '\$(RUNTIME_LIB): runtime\n'
      '\n'
      '\$(OBJ): src/tom_som_cpp_v0.cpp include/tom_som_cpp_v0.hpp | \$(BUILD)\n'
