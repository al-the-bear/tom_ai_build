...
| **7 Back-link** | `@DocSpec([DocRef('DAENT', 'supplies the aggregate this service unit owns and the bounded context that caps it'), DocRef('ARCM', 'supplies the component narrative this service unit realises')])`. |
