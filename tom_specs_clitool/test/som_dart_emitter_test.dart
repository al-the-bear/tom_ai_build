...
void main() {
  ...
  group('SomDartEmitter', () {
    ...
    test(
      'the generated library analyzes clean (no analyzer errors)',
      () async {
        final source = SomDartEmitter(_fixtureModel()).generateLibrary();
...
''');
          ...
          File(
            p.join(libDir.path, 'tom_som_dart_v0.dart'),
          ).writeAsStringSync(source);
          File(
            p.join(libDir.path, 'tom_som_dart_v0_meta.dart'),
          ).writeAsStringSync(
    ...
    test(
      ...
      () {
        ...
        expect(
          SomDartEmitter(stamped, versionLabel: 'v0').modelVersionString,
          '1.3',
        );
        expect(
          SomDartEmitter(stamped, versionLabel: 'v9').modelVersionString,
          '1.3',
        );
      },
    );
