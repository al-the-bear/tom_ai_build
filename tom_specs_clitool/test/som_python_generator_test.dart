...
/// End-to-end tests for the **Python** `v0` SOM generator (som_multiplatform_spec_model.md §10). They
...
void main() {
  ...
  test(
    ...
    () {
      ...
      expect(result.metaModulePath, endsWith('tom_som_python_v0_meta.py'));
